...
<body>
    <div>
        ...
        <ul>
            <li>Click <a href="<%= VirtualPathUtility.ToAbsolute("~/nuget/Packages") %>">here</a> to view your packages.</li>
            <li>Click <a href="<%= VirtualPathUtility.ToAbsolute("~/nuget/clear-cache") %>">here</a> to clear the package cache.</li>
            <li>Click <a href="/home/index">here</a> to manage your packages.</li>
        </ul>
